...
| `apps/api/api/routes/dashboard.py`, `apps/api/api/routes/settings.py`, `apps/web/` — dashboard Phase 4 | [dashboard.md](.claude/rules/dashboard.md) |
| `services/publishing/`, `workers/publishing/`, `api/routes/publishing.py`, `db.PlatformAccount` | [publishing.md](.claude/rules/publishing.md) |
