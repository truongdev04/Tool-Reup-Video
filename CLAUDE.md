...
Ba lớp tách biệt, theo đúng mẫu "logic thuần tách khỏi I/O" của dự án:
...
CPS cho unit quá ngắn thay vì vỡ vụn cue (xem mục subtitle ở trên); QC không
được mâu thuẫn với quyết định đó.
